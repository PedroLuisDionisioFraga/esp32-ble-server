...
// #define FIRST_PROFILE_APP_ID 0x55
...
// static uint16_t user_desc_uuid = ESP_GATT_UUID_CHAR_DESCRIPTION;  // 0x2901
// static uint8_t user_desc_value[] = "Atribute name test";          // Your characteristic name

// static esp_gatts_attr_db_t *gatts_db = NULL;
// static const esp_gatts_attr_db_t gatts_db[GATTS_NUM_HANDLES] = {
//   // Service Declaration
//   [0] =
//     {
...
//           .perm = ESP_GATT_PERM_READ,
//           .max_length = sizeof(user_desc_value),
//           .length = sizeof(user_desc_value),
//           .value = user_desc_value,
//         },
//     },
// };
...
//   // If the gatts_if equal to profile A, call profile A cb handler, so herecall each profile's callback
//   do
//   {
//     int idx;
//     for (idx = 0; idx < s_num_profiles; idx++)
//     {
//       ESP_LOGE(GATTS_TAG,
...
//   {
//     ESP_LOGE(GATTS_TAG, "Maximum number of profiles reached");
...
//   ESP_LOGI(GATTS_TAG, "GATTS callback registered successfully");
//   return ESP_OK;
// }
